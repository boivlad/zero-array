...
const { zeroArray: zero } = require('../src/index');
...
describe('zero', function() {
  ...
  const testCase5 = [
    {
      value_n: 2,
      arr: [1000000034000, 1000000045000, 1000000000045, 1000000000020, 10000000000063, 10000000000045, 10000000000033, 1000000000000, 1000000000000, 1000000000000],
      expected: 'NO'
    },
  ...
  describe('testCase1', function() {
    testCase1.forEach(function(testCase1) {
      it(`should turn ${testCase1.value_n}, [${testCase1.arr}]  to ${testCase1.expected}`,
        function() {
  ...
  describe('testCase2', function() {
    testCase2.forEach(function(testCase2) {
      it(`should turn ${testCase2.value_n}, [${testCase2.arr}]  to ${testCase2.expected}`,
        function() {
          let start = performance.now()
          // You can change the name of function:
  ...
  describe('testCase3', function() {
    testCase3.forEach(function(testCase3) {
      it(`should turn ${testCase3.value_n}, [${testCase3.arr}]  to ${testCase3.expected}`,
        function() {
          let start = performance.now()
          // You can change the name of function:
  ...
  describe('testCase4', function() {
    testCase4.forEach(function(testCase4) {
      it(`should turn ${testCase4.value_n}, [${testCase4.arr}]  to ${testCase4.expected}`,
        function() {
          let start = performance.now()
          // You can change the name of function:
  ...
  describe('testCase5', function() {
    testCase5.forEach(function(testCase5) {
      it(`should turn ${testCase5.value_n}, [${testCase5.arr}]  to ${testCase5.expected}`,
        function() {
          let start = performance.now()
          // You can change the name of function:
